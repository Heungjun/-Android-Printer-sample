...
//        val notificationBuilder = NotificationCompat.Builder(this, channelId)
        val notificationBuilder = NotificationCompat.Builder(this, "Hee Chang")
            .setSmallIcon(R.drawable.ic_stat_ic_notification)
//            .setContentTitle(getString(R.string.fcm_message))
                        .setContentTitle("HeeChang")
...
//            .setSound(defaultSoundUri)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel("Hee Chang",
...
//        val alertDialogBuilder = AlertDialog.Builder(ActivityManager.RunningTaskInfo(1))
